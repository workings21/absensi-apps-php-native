...
<table id="swdatatable" class="table table-bordered">
  ...
  <tbody>';
      $query = "SELECT * FROM building order by building_id  DESC";
    ...
    <tr>
      ...
      <td>' . $row['name'] . '</td>
      <td>' . $row['address'] . '</td>
      <td class="btn-modal" data-latitude="' . $row['lat'] . '" data-longitude="' . $row['long'] . '" data-kantor="' . $row['name'] . '"> Latitude : ' . $row['lat'] . ' <br> Longitude : ' . $row['long'] . ' <br><br> <button class="btn btn-success btn-sm btn-modal" target="blank">Lihat Map</button></td>
      ...
      <td class="text-right">
        <div class="btn-group">';
          ...
          <a href="#modalEdit" class="btn btn-warning btn-xs enable-tooltip" title="Edit" data-toggle="modal"'; ?> onclick="getElementById('txtid').value='<?PHP echo $row['building_id']; ?>';
            getElementById('txtname').value='<?PHP echo $row['name']; ?>';
            getElementById('txtaddress').value='<?PHP echo $row['address']; ?>';
            getElementById('txtlatitude').value='<?PHP echo $row['lat']; ?>';
            getElementById('txtlongitude').value='<?PHP echo $row['long']; ?>';
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control latitude" name="latitude" required></input>
        </div>
        <div class="form-group">
            <label>Longitude</label>
            <input type="text" class="form-control longitude" name="longitude" required></input>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label>Latitude</label>
            <input type="text" class="form-control latitude" id="txtlatitude" name="latitude" required></input>
          </div>
          <div class="form-group">
              <label>Longitude</label>
              <input type="text" class="form-control longitude" id="txtlongitude" name="longitude" required></input>
          </div>
      </div>
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary pull-left"><i class="fa fa-check"></i> Simpan</button>
